...
export default function App() {
  ...
  // আগের কপি ফাংশনগুলো (ঠিক রাখা হয়েছে)
  ...
  return (
    <div className="min-h-screen bg-slate-50 pb-10">
      <header className="bg-blue-700 text-white pt-10 pb-20 px-4 text-center">
        <img src="/logo.png" alt="School Logo" className="mx-auto mb-3 w-20 h-20 object-contain drop-shadow-md" />
      ...
      <main className="max-w-4xl mx-auto -mt-10 px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          {filtered.map((st: any) => (
            <div key={st.id} className="bg-white p-5 rounded-[2rem] shadow-sm border border-slate-200">
              ...
              {/* বাটন সেকশন: এখানে ৪টি আগের এবং ২টি নতুন বাটন আছে */}
              <div className="grid grid-cols-2 gap-2">
                ...
                {/* নতুন যুক্ত হওয়া হোয়াটসঅ্যাপ বাটন */}
                <button onClick={() => sendDueWhatsApp(st)} className="bg-green-600 text-white p-2.5 rounded-xl text-[10px] font-bold flex items-center justify-center gap-1 col-span-1 shadow-md shadow-green-100">
                  <MessageCircle size={14}/> বকেয়া (WhatsApp)
                </button>
                <button onClick={() => sendAbsentWhatsApp(st)} className="bg-green-600 text-white p-2.5 rounded-xl text-[10px] font-bold flex items-center justify-center gap-1 col-span-1 shadow-md shadow-green-100">
        ...
        <footer className="mt-20 py-10 text-center border-t border-slate-200">
          <div className="flex flex-col items-center gap-3">
            <img src="/gias.jpg" alt="গিয়াস উদ্দিন" className="w-14 h-14 rounded-full border-4 border-white shadow-md" />
            <p className="text-slate-400 font-bold text-xs">
              অ্যাপ ডেভেলপারঃ <span className="text-blue-600">অ্যাপ ডেভেলপার: গিয়াস উদ্দিন</span>
            </p>
          </div>
        </footer>

        {/* Admission Form: আপনার দেওয়া মূল ফরমের লেখা ও ডিজাইন হুবহু রাখা হয়েছে */}
        <AnimatePresence>
          {showForm && (
